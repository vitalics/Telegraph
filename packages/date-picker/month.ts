...
class MainEvents extends Event<[ctx: Context<Update>, date: Dayjs], 'click' | 'prev' | 'next'>{ }

class YearOrMonth extends Event<[ctx: Context<Update>, yearOrMonth: number], 'year' | 'month'> {
}

export default class MonthPicker extends InlineComponent<[YearOrMonth, MainEvents]> {
